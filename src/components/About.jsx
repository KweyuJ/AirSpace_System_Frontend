...
import VisionImage from '../assets/vision2.jpeg';
...
import AboutUsHeaderImage from '../assets/relaxing.png'; 
    ...
    <div className="about-us-page">
      <div className="about-us-header">
        ...
        <div className="header-section">
          <h1>About Us</h1>
          <p>Welcome to AirEscape, your go-to platform for seamless and hassle-free travel and flight booking.</p>
        </div>
      </div>
